...
>
> The following optional mods are available currently:
> mikepauer/amp:java -- Installs java runtimes into the docker instance
> mikepauer/amp:steam -- Installs i386 system and required libraries for steamcmd to work
